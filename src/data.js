...
window.ARTWORKS = [
  // ── MENNA HOSSAM (Collection 01 — featured artist) ─────────────
  {
    ...
    image: (window.__resources&&window.__resources.mennaHera||'src/assets/menna-hera-framed.png'),
    ...
    landscape: true, fit: 'contain', aspectRatio: '19 / 15',
  ...
  },
  {
    ...
    artist: 'Menna Hossam', artistId: 'menna-hossam',
    image: (window.__resources&&window.__resources.mennaSwan||'src/assets/menna-swan-maiden-framed.png'),
  ...
  },
  {
    ...
    artist: 'Menna Hossam', artistId: 'menna-hossam',
    image: (window.__resources&&window.__resources.mennaRenard||'src/assets/menna-le-renard-framed.png'),
...
window.ARTISTS = [
  {
    ...
    heroImage: (window.__resources&&window.__resources.mennaHero||'src/assets/menna-hero.jpg'),
